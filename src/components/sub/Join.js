...
const Join = () => {
  ...
  const check = (_val) => {
    ...
    //관심사
    if (!_val.interests) {
      errs.interests = "관심사를 하나이상 선택해 주세요.";
    }
    //학력체크
    if (_val.edu === "") {
      errs.edu = "학력을 선택하세요.";
              ...
              <tr>
                ...
                <td>
                  <select name="edu" id="edu" onChange={handleChange}>
                    ...
                    <option value="step-1">중학교 졸업</option>
                    <option value="step-2">고등학교 졸업</option>
                    <option value="step-3">대학교 졸업</option>
                    <option value="step-4">대학원 졸업</option>
                  </select>
